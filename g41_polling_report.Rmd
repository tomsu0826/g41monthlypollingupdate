...
    In order to protect the privacy of our respondent, no personal information would be included in the publication dataset. Along with that, every participant of the project signed the privacy contract on not leaking our respondent’s private information and using it anywhere else than our project.
